...
import { formatDateShort, formatIDR, monthKey, monthLabel } from '../lib/format'
...
const CashflowAreaChart = lazy(() => import('../components/dashboard/CashflowAreaChart'))
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="grid gap-5 lg:grid-cols-5">
        <Suspense fallback={<Skeleton className="h-60 lg:col-span-3" />}>
          <CashflowAreaChart chartData={chartData} isMobile={isMobile} isBlurred={isBlurred} />
        </Suspense>
